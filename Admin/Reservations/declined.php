  ...
  <body style = 'font-family:san;font-size:18px;'>
    ...
    <div class="container-fluid">
      ...
      <li class='last'><a href='../Reservations/payed.php'><span> Payed Reservations</span></a></li>
        ...
        <h1 class='page-header'>Declined Reservation</h1>
        <?php 
        $users = mysql_query("SELECT * FROM reservation_tbl WHERE r_status=2");
          if(mysql_num_rows($users) > 0){
            ...
            echo "<div class='inner'><p style='color:#686868;font-size:30px'>No declined reservations</p></div>";
          }
        ?>  
        </div>
      </div>
