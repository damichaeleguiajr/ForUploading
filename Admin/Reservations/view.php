  ...
  <body style = 'font-family:san;font-size:18px;'>
    ...
    <div class="container-fluid">
      ...
      <li><a href='#'><span>Promo Packages</span></a></li>
			...
			<ul>
			<li class='active'><a href='#'><span>Pending Reservations</span></a></li>
			<li ><a href='approve.php'><span>Approved Reservations</span></a></li>
			<li class='last'><a href='declined.php'><span> Declined Reservations</span></a></li>
			</ul>
			</li>
          ...
          echo "<div class='col-lg-12'>
              ...
              echo   "</tbody>
                ...
                <div class='col-lg-12 summary'>
                  ...
                  <form method = 'POST' action = 'view.php?id=".$idd."'>
