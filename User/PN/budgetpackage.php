...
<body>
        ...
        echo "<table width = '100%' id='budgetTable' class='striped'>
                <tbody>
                <tr>
        ...
        while($selectedpackage = mysql_fetch_array($qryitems)){
            ...
            while ($pricelist = mysql_fetch_array($price)) {
                ...
                echo "<tr id = '".$i."' blinked='".$item_id."' class='iLoveCode' iLoveCode='".$priceThis."' sameprice='".$itemOriginal."'>
                        ...
                        <td class = 'centerthis' width='30%'>
                            <button type = 'button' item='".$itemPrice."' priceTag='".$item_id."' searchfor = '".$item_id."'' id='".$i."' class = 'btn btn-success modalnow' data-toggle='modal' data-target='#myModal'><span class='fa fa-edit'></span></button>
        ...
        echo "<div class='col-lg-12' id = 'thisAddItem' style='padding-top:20px'>
              ...
              <div class='col-lg-12'>
                <div class ='col-lg-6' align = 'right'>
                    <div>
                        <label class='form-group'>Total Price:  ₱</label><input type='text' class='asd totalthisnow' name='totalamount' readonly value=''><br>
                    </div>
                    <div id='fortotalbudget'>
                        <label class='form-group'>Budget:  ₱</label><input type='text' class='asd totalbudget' readonly value=''>
                    </div>
                    <hr style='margin-top:-10px'>
                    <div id='forremaining'>
                        <label class='form-group'>Remaining Budget:  ₱</label><input type='text' class='asd remainingbudget' readonly value=''>
                    </div>
                </div>
              </div>";
        echo "</div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body modalitemheight scroll">
                    ...
                    <div class="tab-pane fade active in" id="all">
                        ...
                        <fieldset>
                        <table class='table-hover' width = '100%' id='myTable'>
                            <tr>
                                <th>Item name</th>
            ...
            <div class="modal fade bs-modal-sm" id="myModalAdd" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="bs-example bs-example-tabs">
                        <ul id="myTab" class="nav nav-tabs">
                          <li class="active"><a href="#availableforbudget" data-toggle="tab">Available item/s for your budget</a></li>
                          ...
                          <li class=""><a href="#allitem" data-toggle="tab">All</a></li>
                        </ul>
                    </div>
                  <div class="modal-body modalitemheight scroll">
                    <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade active in" id="availableforbudget">
                        <form class="form-horizontal"> 
                        <fieldset id='availableitem'>
