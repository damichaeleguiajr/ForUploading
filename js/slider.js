$(document).ready(function(){
	...
	var img1 = $('#bigImage1').attr("src", "../images/adult themes/" + image1 + ".jpg");
	var img2 = $('#bigImage2').attr("src", "../images/adult themes/" + image2 + ".jpg");
    var img3 = $('#bigImage3').attr("src", "../images/adult themes/" + image3 + ".jpg");
