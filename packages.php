    ...
    <div class="container jumbotron forbody">
        ...
        <div class = 'row'>
         ...
         <div class="col-md-3">
                     <div class="thumbnail">
                            <div class="caption">
                                <center><h4>SET A</h4></center>
                                <ul>
                                    <li>SPAGHETTI</li>
                                    <li>CHICKEN LOLLIPOP/SHANGHAI ROLLS/BBQ</li>
                                    <li>HOTDOG WITH MALLOWS</li>
                                    <li>TETRA PACK JUICE</li>
                                </ul>  

                                <h4 class="pull-right">₱120.00 PER HEAD</h4>
                ...
                <div class="col-sm-3">
                     <div class="thumbnail">
                            <center><h4>SET B</h4></center>
                                <ul>
                                    <li>SPAGHETTI</li>
                                    <li>CHICKEN LOLLIPOP/SHANGHAI ROLLS/BBQ</li>
                                    <li>HOTDOG WITH MALLOWS</li>
                                    <li>TETRA PACK JUICE</li>
                                    <li>CHOCO FOUTAIN IN WITH MALLOWS AND PRETZELS</li>
                                    <li>KIDDY SET (CHAIRS AND TABLES)</li>

                                </ul>  

                                <h4 class="pull-right">₱250.00 PER HEAD</h4>
                                <h4><a href="#">Order</a></h4>
                    </div>
                </div>
                <div class="col-sm-3">
                     <div class="thumbnail">
                            <center><h4>BUFFET 1</h4></center>
                                <ul>
                                    <li>CHICKEN AFRITADA</li>
                                    <li>FISH FILLET WITH TOFU AND BLACK BEANS</li>
                ...
                <div class="col-md-3 col-offset-3">
                     <div class="thumbnail">
                            <center><h4>BUFFET 2</h4></center>
                                <ul>
                                    <li>PORK STEW</li>
                                    <li>FISH FILLET WITH SWEET AND SOUR SAUCE</li>
                                    <li>MIXED VEGETABLES</li>
                                    <li>PANCIT CANTON</li>
                                    <li>STEAMED RICE</li>
                                    <li>ICED TEA</li>
            ...
            <div class = 'row'>
                ...
                <div class="col-sm-3">
                     <div class="thumbnail">
                            <center><h4>SET C</h4></center>
                                <ul>
                                    <li>OX TAIL IN PEANUT SAUCE</li>
                                    <li>FRIED CHICKEN WITH GRAVY</li>
                                    <li>FISH FILLET WITH SWEET AND SOUR SAUCE</li>
                                    <li>MIXED VEGETABLES</li>
                                    <li>PANCIT CANTON</li>
                                    <li>STEAMED RICE</li>
                                ...
                                <h4 class="pull-right">₱260.00 PER HEAD</h4>
                                <h4><a href="#">Order</a></h4>
                    </div>
                </div>
            </div>
