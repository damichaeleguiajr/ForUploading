        ...
        <div class = 'row'>
         <div class="col-lg-3">
                <div class="list-group">
                    <a href="services.html" class="list-group-item">Audio Visuals</a>
                    <a href="pvcoverage.html" class="list-group-item active">Photo/Video Coverage</a>
                    <a href="entertainment.html" class="list-group-item">Entertainment</a>
                </div>
                </div>
                <div class="col-md-3">
                     <div class="thumbnail">
                            <img src="img/videography.jpg">
                            <div class="caption">
                                <h4 class="pull-right">₱4,000.00</h4>
